        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 xl:gap-12 items-center">
          ...
          <div className="lg:col-span-6 xl:col-span-5 flex flex-col items-start gap-4 sm:gap-5">
            ...
            <div className="flex flex-wrap items-center gap-3.5 pt-2">
              ...
              <Link
                href="/beginner-guide"
                className="inline-flex items-center justify-center gap-2 bg-white hover:bg-gray-50 text-gray-700 hover:text-gray-900 text-lg font-medium px-6 py-3.5 rounded-lg border border-gray-300 transition-all whitespace-nowrap"
              >
