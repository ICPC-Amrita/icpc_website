    ...
    <section className="w-full bg-white px-4 sm:px-8 lg:px-14 xl:px-20 pb-14">
      <div className="max-w-full mx-auto border border-hairline rounded-2xl p-6 sm:p-10 bg-paper shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 items-stretch">
          <Reveal className="p-6 rounded-xl border border-hairline bg-white hover:shadow-md transition-shadow text-center flex flex-col justify-center">
          ...
          <Link
            href="/halloffame"
            className="h-full p-6 rounded-xl bg-contest-blue text-white flex flex-col justify-center items-center text-center gap-2 shadow-sm hover:bg-contest-blue-dark transition-colors"
          >
