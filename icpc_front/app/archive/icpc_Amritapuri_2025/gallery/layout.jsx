...
export default function Layout({ children }) {
    ...
    useEffect(() => {
        ...
        const updateScrollDir = () => {
            ...
            if (scrollY>window.innerHeight || (window.innerWidth<680 && scrollY>window.innerWidth) || pathname=='/archive/icpc_Amritapuri_2025/promote' || pathname=='/archive/icpc_Amritapuri_2025/gallery'){
                setHero(false);
            }else{
                setHero(true);
            }
