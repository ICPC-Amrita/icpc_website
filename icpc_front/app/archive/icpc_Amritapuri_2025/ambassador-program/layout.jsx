...
import Terminal from "@/app/archive/components25/ui_elems/terminal/terminalnew";
...
export default function Layout({ children }) {
    ...
    useEffect(() => {
        ...
        const updateScrollDir = () => {
            ...
            if (scrollY > window.innerHeight || (window.innerWidth < 680 && scrollY > window.innerWidth) || pathname=='/archive/icpc_Amritapuri_2025/ambassador-program') {
                setHero(false);
            } else {
                setHero(true);
            }
                                ...
                                <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
                                    ...
                                    <nav aria-labelledby="quick-links-heading">
                                        ...
                                        <ul className="mt-4 space-y-3 text-gray-300">
                                            ...
                                            <li>
                                                <Link href="/archive/icpc_Amritapuri_2025" className="transition-colors hover:text-sky-400">
                                                    Registration
                                                </Link>
                                            </li>
                                            <li>
