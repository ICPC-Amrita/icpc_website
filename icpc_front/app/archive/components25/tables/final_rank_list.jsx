            ...
            <div className="flex-1 flex flex-col min-w-[80vw] max-md:min-w-[95vw] max-md:max-w-[95vw] items-center">
                <div className="text-center mb-[4vw] max-w-[80vw] max-md:min-w-[95vw]">
                    ...
                    {/* <p className="text-[1.2vw] max-md:text-[3.5vw] text-gray-200 mb-[1vw]">
                        ...
                        <Link href="/archive/icpc_Amritapuri_2025/team-selection-process"><span className="font-semibold text-blue-500 hover:text-purple-900 underline mt-[1vw]">The Team Selection Criteria</span></Link> 
                        &nbsp;for Amritapuri Multi Site and&nbsp;
                        <Link href="/archive/icpc_Amritapuri_2025/ranking-process"><span className="font-semibold text-blue-500 hover:text-purple-900 underline mt-[1vw]">The Ranking Process</span></Link>. 
