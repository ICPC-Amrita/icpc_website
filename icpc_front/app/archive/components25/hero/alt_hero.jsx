    ...
    <span className="inline-block text-blue-700 text-xs sm:text-sm font-medium px-3 py-1.5 sm:px-4 sm:py-2 ">
        {/* Highlights: 310+ Onsite Slots ! Thankyou Everyone for making ICPC Amritapuri Regionals 2025 a Huge Success! */}
                    ...
                    <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-700 font-medium mb-4 sm:mb-6 md:mb-8 leading-relaxed">
                        <Link href={'/archive/icpc_Amritapuri_2025/reach-us/bengaluru'} className="hover:text-blue-600 transition-colors duration-300">
                            Bengaluru
                        </Link> , <Link href={'/archive/icpc_Amritapuri_2025/reach-us/coimbatore'} className="hover:text-blue-600 transition-colors duration-300">
                            Coimbatore
                        </Link> , <Link href={'/archive/icpc_Amritapuri_2025/reach-us/amritapuri'} className="hover:text-blue-600 transition-colors duration-300">
                            Kollam
...
<div className="mb-6 sm:mb-8 md:mb-12 space-y-3">
  ...
  {/* <FaMedal className="shrink-0 text-base sm:text-lg" /> */}
                    <a
  href="/archive/icpc_Amritapuri_2025/onsite-ranklist"
