...
export default function Navbar({ open, hero, darkSection }) {
  ...
  const locations = [
    { name: "Amritapuri", href: "/archive/icpc_Amritapuri_2025/reach-us/amritapuri" },
    { name: "Bengaluru", href: "/archive/icpc_Amritapuri_2025/reach-us/bengaluru" },
    { name: "Coimbatore", href: "/archive/icpc_Amritapuri_2025/reach-us/coimbatore" },
    { name: "Mysuru", href: "/archive/icpc_Amritapuri_2025/reach-us/mysuru" },
  ];

  const locations24 = [
    {
      name: "Amritapuri",
      href: "/archive/icpc_Amritapuri_2024/reach-us/amritapuri",
    },
    {
      name: "Bengaluru",
      href: "/archive/icpc_Amritapuri_2024/reach-us/bengaluru",
    },
    {
      name: "Coimbatore",
      href: "/archive/icpc_Amritapuri_2024/reach-us/coimbatore",
    },
  ];
  ...
  // Function to handle smooth scrolling to sections
  const handleSmoothScroll = (e, targetId, basePath = "/archive/icpc_Amritapuri_2025") => {
    e.preventDefault();
  ...
  const getNavigationItems = () => {
    if (currentPath.startsWith("/archive/icpc_Amritapuri_2024")) {
      ...
      return [
        { label: "Home", href: "/archive/icpc_Amritapuri_2025", type: "link" },
        { label: "Why Amrita", href: "#perks", type: "scroll", basePath: "/archive/icpc_Amritapuri_2025" },
        { label: "FAQ", href: "#faq", type: "scroll", basePath: "/archive/icpc_Amritapuri_2025" },
        { label: "Hall of Fame", href: "/archive/icpc_Amritapuri_2025/halloffame", type: "link" },
        { label: "Prelims Ranklist", href: "/archive/icpc_Amritapuri_2025/prelims-ranklist", type: "link" },
        { label: "Reach Us", type: "dropdown", items: locations },
        { label: "Onsite Ranklist", href: "/archive/icpc_Amritapuri_2025/onsite-ranklist", type: "link" },
        { label: "Organizers", href: "/archive/icpc_Amritapuri_2025/organizers", type: "link" },
        { label: "Schedule", href: "/archive/icpc_Amritapuri_2025/onsite-schedule", type: "link" },
        { label: "Winners", href: "/archive/icpc_Amritapuri_2025/onsite-winners", type: "link" },
        { label: "Archive", type: "dropdown", items: archiveweblinks },
        { label: "Calendar", href: "/archive/icpc_Amritapuri_2025/calendar", type: "link" },
      ];
    }
  };
